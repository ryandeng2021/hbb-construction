...
export const projects = [
  {
    ...
    status: 'completed',
    image: getAssetPath('/img/17-3.jpg'),
    ...
    content: [
      ...
      },
      {
        ...
        images: [
          {
            src: getAssetPath('/img/17-8.jpg'),
            alt: 'Residential units',
          },
          {
            src: getAssetPath('/img/17-9.jpeg'),
            alt: 'Commercial office spaces',
          },
        ]
      },
      {
        ...
        images: [
          {
            src: getAssetPath('/img/17-10.jpeg'),
            alt: 'Residential units',
          },
          {
  ...
  },
  {
    ...
    category: 'House Addition & Remodel',
    status: 'completed',
    image: getAssetPath('/img/18-3.jpg'),
    description: 'Large openings allow daylight to penetrate deep into the interior, enhancing spatial depth and clarity.',
    location: 'Sunnyvale',
    year: '2026',
    ...
    content: [
      ...
      },
      {
        ...
        images: [
          ...
          {
            src: getAssetPath('/img/18-9.jpeg'),
            alt: 'Commercial office spaces',
          },
        ]
      },
      {
        ...
        images: [
          {
            src: getAssetPath('/img/18-10.jpeg'),
            alt: 'Residential units',
          },
          {
      ...
      },
      {
        ...
        images: [
          ...
          {
            src: getAssetPath('/img/18-16.jpg'),
            alt: 'Commercial office spaces',
          },
        ]
      },
